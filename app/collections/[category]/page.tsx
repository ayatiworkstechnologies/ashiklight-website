  ...
  return (
    <ScrollRevealProvider>
      <main className="min-h-screen flex flex-col bg-[#050505]">
        ...
        <section className="relative min-h-[50vh] flex items-center overflow-hidden bg-[#050505] border-b border-[#D4AF37]/25">
          <div className="absolute inset-0 z-0">
            ...
            />
            <div className="absolute inset-y-0 left-0 w-full md:w-[58%] lg:w-[48%] bg-gradient-to-r from-[#050505] via-[#050505]/90 to-transparent pointer-events-none" />
          </div>
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 py-14 lg:py-20 w-full">
            <div className="max-w-xl lg:max-w-2xl space-y-5">
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#D4AF37]/15 border border-[#D4AF37]/30 text-[#D4AF37] text-xs font-semibold uppercase tracking-wider backdrop-blur-sm shadow-2xs">
                ...
                {currentConfig.badges.map((b, i) => {
                  ...
                  return (
                    <div
                      ...
                      className="flex items-center gap-2 text-xs font-semibold text-[#D4AF37] bg-[#D4AF37]/15 backdrop-blur-md px-4 py-2.5 rounded-xl border border-[#D4AF37]/25 shadow-2xs transition-all duration-300"
                    >
                      <BIcon className="w-4 h-4 text-[#D4AF37]" />
                      <span>{b.text}</span>
                    </div>
                  );
                })}
        ...
        <section ref={catalogRef} className="py-12 lg:py-16 bg-[#050505] scroll-mt-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
              ...
              <div className="lg:col-span-3 bg-[#161616] rounded-2xl p-6 border border-[#D4AF37]/25 space-y-6" data-reveal="left">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8" data-reveal-stagger>
                  {currentConfig.products.map((p, index) => (
                    <div
                      ...
                      className="group bg-[#161616] rounded-2xl overflow-hidden border border-[#D4AF37]/25 shadow-2xs hover-border-glow hover:shadow-xl transition-all duration-400 transform hover:-translate-y-2 flex flex-col justify-between cursor-pointer"
                    >
                      ...
                      <div className="p-4 bg-[#161616] border-t border-[#D4AF37]/15">
                        <h3 className="font-semibold text-white text-sm group-hover:text-[#D4AF37] transition-colors duration-300">
                          {p.title}
                        </h3>
                      </div>
                    </div>
