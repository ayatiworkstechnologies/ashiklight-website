...
export default function Footer() {
  return (
    <footer className="bg-[#0A1628] text-slate-300 pt-16 pb-8 border-t border-white/15 relative overflow-hidden">
      <VectorDiamondGrid className="opacity-[0.03]" />
      <VectorCornerMotif position="top-right" />
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
        <div
          className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 pb-12 border-b border-white/15"
          data-reveal-stagger
        >
          ...
          <div className="lg:col-span-4 space-y-4" data-reveal="up">
            ...
            {/* Google Rating Badge */}
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/10 border border-white/15 text-xs text-slate-300">
              <div className="flex items-center text-slate-100">
                <Star className="w-3.5 h-3.5 fill-slate-100" />
                <Star className="w-3.5 h-3.5 fill-slate-100" />
                <Star className="w-3.5 h-3.5 fill-slate-100" />
                <Star className="w-3.5 h-3.5 fill-slate-100" />
                <Star className="w-3.5 h-3.5 fill-slate-100" />
          ...
          <div className="lg:col-span-4 space-y-4" data-reveal="up" data-reveal-delay="100">
            <h4 className="font-serif text-sm font-semibold uppercase tracking-wider text-white border-b border-white/15 pb-2 inline-block">
              Collections
            </h4>
            <ul className="grid grid-cols-2 gap-2 text-xs text-slate-400">
              <li>
                <Link href="/chandeliers" className="link-underline hover:text-white transition-colors duration-300">
                  Chandeliers
                </Link>
              </li>
              <li>
                <Link href="/high-ceiling-chandeliers" className="link-underline hover:text-white transition-colors duration-300">
                  High Ceiling
                </Link>
              </li>
              <li>
                <Link href="/indoor-lights" className="link-underline hover:text-white transition-colors duration-300">
                  Indoor Lights
                </Link>
              </li>
              <li>
                <Link href="/decorative-fans" className="link-underline hover:text-white transition-colors duration-300">
                  Decorative Fan
                </Link>
              </li>
              <li>
                <Link href="/wall-pendant-lights" className="link-underline hover:text-white transition-colors duration-300">
                  Wall & Pendant
                </Link>
              </li>
              <li>
                <Link href="/led-mirrors" className="link-underline hover:text-white transition-colors duration-300">
                  LED Mirror
                </Link>
              </li>
              <li>
                <Link href="/architectural-lights" className="link-underline hover:text-white transition-colors duration-300">
                  Architectural
                </Link>
              </li>
              <li>
                <Link href="/outdoor-lights" className="link-underline hover:text-white transition-colors duration-300">
                  Outdoor Lights
                </Link>
              </li>
            </ul>
