...
export default function Showrooms() {
  return (
    <section id="showrooms" className="py-14 lg:py-20 bg-[#050505] border-t border-[#D4AF37]/25">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
        <div
          className="bg-[#161616] rounded-3xl p-6 sm:p-10 border border-[#D4AF37]/25 shadow-2xl grid grid-cols-1 lg:grid-cols-12 gap-8 items-center"
          data-reveal="scale"
        >
          {/* Left Info */}
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="space-y-3.5 text-xs sm:text-sm text-slate-300">
              ...
              <div className="flex items-center gap-3">
                ...
                <a href="tel:08754860555" className="font-bold text-[#D4AF37] hover:underline">
                  087548 60555
                </a>
              </div>
            ...
            <div className="pt-2 flex items-center gap-3">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="btn-shimmer px-6 py-3 text-xs font-bold rounded-xl shadow-md inline-flex items-center gap-2 transition-all cursor-pointer group"
              >
          ...
          {/* Right Embedded Map */}
          <div className="lg:col-span-7 rounded-2xl overflow-hidden border border-[#D4AF37]/25 shadow-md h-[320px] sm:h-[360px]">
            <iframe
