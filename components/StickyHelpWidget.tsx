    ...
    <div className="hidden lg:flex fixed right-4 sm:right-6 bottom-6 z-50 flex-col items-end gap-3 pointer-events-none">
      <div className="pointer-events-auto flex flex-col items-end gap-3">
        ...
        <a
          ...
          className="w-12 h-12 rounded-full bg-[#161616] hover:bg-[#D4AF37] text-[#D4AF37] flex items-center justify-center shadow-xl transition-all duration-300 hover:scale-110 cursor-pointer border border-[#D4AF37]/30 group"
