...
export default function Testimonials() {
  ...
  return (
    <section
      id="reviews"
      className="py-16 lg:py-24 bg-[#0A1628] border-t border-[#D4A017]/15 overflow-hidden"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
        ...
        <div className="max-w-4xl mx-auto relative" data-reveal="scale">
          ...
          <div className="w-full bg-[#0D1E35] h-1.5 rounded-full mb-4 overflow-hidden border border-[#D4A017]/15">
            <div
              ref={progressRef}
          ...
          <div className="bg-[#0D1E35] rounded-3xl p-8 sm:p-12 border border-[#D4A017]/20 shadow-xl relative overflow-hidden transition-all duration-500 hover:shadow-2xl">
            <MessageSquareQuote className="absolute top-6 right-6 w-16 h-16 text-[#D4A017]/10" />
            ...
            >
              ...
              {/* Author & Showroom */}
              <div className="pt-4 border-t border-[#D4A017]/15 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center gap-2 text-xs font-semibold text-[#D4A017] hover:underline"
                >
          ...
          <div className="flex items-center justify-between mt-6">
            <div className="flex items-center gap-3">
              <button
                ...
                className="w-8 h-8 rounded-full bg-[#0D1E35] border border-[#D4A017]/25 text-slate-300 hover:text-[#D4A017] hover:border-[#D4A017] flex items-center justify-center transition-all duration-300 cursor-pointer"
                title={isPlaying ? "Pause auto-scroll" : "Play auto-scroll"}
              >
                {isPlaying ? <Pause className="w-3.5 h-3.5" /> : <Play className="w-3.5 h-3.5" />}
              </button>

              <div className="text-xs font-semibold text-slate-300 bg-[#0D1E35] px-3 py-1 rounded-full border border-[#D4A017]/25">
                <span className="text-[#D4A017] font-bold">{currentIndex + 1}</span> / {reviews.length} Reviews
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              <button
                onClick={prevReview}
                className="w-10 h-10 rounded-full bg-[#0D1E35] border border-[#D4A017]/25 text-slate-200 hover:border-[#D4A017] hover:text-[#D4A017] hover:shadow-md flex items-center justify-center transition-all duration-300 cursor-pointer"
