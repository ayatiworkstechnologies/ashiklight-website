      ...
      <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
        <defs>
          <pattern id="diamondGrid" width="40" height="40" patternUnits="userSpaceOnUse">
            <path d="M 20 0 L 40 20 L 20 40 L 0 20 Z" fill="none" stroke="#B8860B" strokeWidth="1" />
  ...
  return (
    <div className={`absolute pointer-events-none ${className}`}>
      <svg width="300" height="300" viewBox="0 0 300 300" fill="none" xmlns="http://www.w3.org/2000/svg" className="opacity-20">
        <circle cx="150" cy="150" r="140" stroke="#B8860B" strokeWidth="1" strokeDasharray="4 6" />
        <circle cx="150" cy="150" r="100" stroke="#D4AF37" strokeWidth="1" />
        <line x1="150" y1="0" x2="150" y2="300" stroke="#B8860B" strokeWidth="0.75" />
        <line x1="0" y1="150" x2="300" y2="150" stroke="#B8860B" strokeWidth="0.75" />
        <line x1="43.93" y1="43.93" x2="256.07" y2="256.07" stroke="#B8860B" strokeWidth="0.5" />
        <line x1="256.07" y1="43.93" x2="43.93" y2="256.07" stroke="#B8860B" strokeWidth="0.5" />
      </svg>
    </div>
  );
}
  ...
  return (
    <div className={`absolute ${posClasses[position]} pointer-events-none w-20 h-20 opacity-25 z-0`}>
      <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M0 0 H60 C60 30 30 60 0 60 V0 Z" fill="url(#goldGrad)" opacity="0.15" />
        <path d="M0 20 H40 C40 40 20 40 0 40" stroke="#B8860B" strokeWidth="1.5" />
  ...
  return (
    <div className={`absolute pointer-events-none ${className}`}>
      <svg width="240" height="320" viewBox="0 0 240 320" fill="none" xmlns="http://www.w3.org/2000/svg" className="opacity-15">
        <path d="M10 310 V120 C10 59.25 59.25 10 120 10 C180.75 10 230 59.25 230 120 V310" stroke="#B8860B" strokeWidth="1.5" strokeDasharray="6 6" />
